...
//
//     final vIsitorsServiceCompleteResponseModel = vIsitorsServiceCompleteResponseModelFromJson(jsonString);
...
VisitorsServiceCompleteResponseModel visitorsServiceCompleteResponseModelFromJson(String str) => VisitorsServiceCompleteResponseModel.fromJson(json.decode(str));

String visitorsServiceCompleteResponseModelToJson(VisitorsServiceCompleteResponseModel data) => json.encode(data.toJson());

class VisitorsServiceCompleteResponseModel {
  String? status;
  VisitorsServiceComplete? record;
  int? code;
  dynamic meta;
  bool? requestStatus;
  String? message;

  VisitorsServiceCompleteResponseModel({
    this.status,
    this.record,
    this.code,
    this.meta,
  ...
  factory VisitorsServiceCompleteResponseModel.fromJson(Map<String, dynamic> json) => VisitorsServiceCompleteResponseModel(
    status: json["status"],
    record: json["record"] == null ? null : VisitorsServiceComplete.fromJson(json["record"]),
    code: json["code"],
    meta: json["meta"],
...
class VisitorsServiceComplete {
  ...
  factory VisitorsServiceComplete.fromJson(Map<String, dynamic> json) => VisitorsServiceComplete(
    id: json["id"],
...
//     "sync_from": "${syncFrom!.year.toString().padLeft(4, '0')}-${syncFrom!.month.toString().padLeft(2, '0')}-${syncFrom!.day.toString().padLeft(2, '0')}",
