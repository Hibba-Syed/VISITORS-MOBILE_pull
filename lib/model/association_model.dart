...
class Association {
  ...
  factory Association.fromJson(Map<String, dynamic> json) => Association(
        ...
        oamCompany: json["oam_company"] == null
            ? null
            : OamCompany.fromJson(json["oam_company"]),
        visitorsPurposes: json["visitors_purposes"] == null
            ? []
            : List<VisitorsPurpose>.from(json["visitors_purposes"]!
                .map((x) => VisitorsPurpose.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "visitors_purposes": visitorsPurposes == null
            ? []
            : List<dynamic>.from(visitorsPurposes!.map((x) => x.toJson())),
